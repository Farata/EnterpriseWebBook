...
The chances are that your application will transmit JSON over the wire in which case you want to chose the text opcode. When your code emits binary data it will be represented in a browser specific `Blob` object.
