...
TIP: For more information about debugging JavaScript, refer to the code samples illustrated in Figures pass:[<xref linkend="FIG2-8" xrefstyle="select: labelnumber"/>] and pass:[<xref linkend="FIG2-9" xrefstyle="select: labelnumber"/>].
