...
The easiest way to create a JavaScript object is by using _object literal notation_.(((JavaScript, objects, literals))) The following code sample begins with the creation of an empty object: 
