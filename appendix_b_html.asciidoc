...
The majority of modern web browsers already support the current version of the http://bit.ly/1oEqN0z[HTML5 specification], which will become a World Wide Web Consortium (W3C) standard in 2014. The question is whether the users of your web application have a modern browser installed on their device? There are two groups of users who will stick to outdated browsers for some time:
