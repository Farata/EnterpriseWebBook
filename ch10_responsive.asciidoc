...
Jerry gives us several versions of the images--with and without the grid background. The use of the grid is explained later, in<<MMMMMMMMMMM>>. <<FIG11-5>> depicts the rendering on tablet devices with a screen that is under 768 pixels wide in portrait mode.
