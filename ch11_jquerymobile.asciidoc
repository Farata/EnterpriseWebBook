...
One of the ways to arrange navigation is to add persistent toolbars that never go away while your application is running. You can add such a toolbar in the footer or header area or in both. We'll create a simple example illustrating this technique by adding a `navbar` to the footer area of the application.  Suppose that your application has a starting page and four other pages that can be selected by the user. <<FIG12-6>> shows the initial view of the application.(((jQuery Mobile, persistent toolbars)))(((toolbars, peristent)))(((persistent toolbars)))((("navbars (navigation bars)")))
