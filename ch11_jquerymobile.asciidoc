...
<<FIG12-12>> and <<FIG12-13>> also show mockups in portrait mode; <<FIG12-12>> displays two versions of the Who We Are page, and <<FIG12-13>> depicts two versions of the Donate page.
