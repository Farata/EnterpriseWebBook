...
All of these images show UI layouts when the mobile device is in portrait mode, but you should ask your web designer to prepare mockups for landscape mode, too. <<FIG12-21>>, <<FIG12-22>>, <<FIG12-23>>, and <<FIG12-24>> show snapshots in landscape mode that Jerry also prepared prepared for us.(((portrait mode)))(((landscape mode)))
