...
TIP: Internet Explorer 8 and older don't natively support media queries - consider using the libraries media-queries.js or respond.js to resolve this issue. 
