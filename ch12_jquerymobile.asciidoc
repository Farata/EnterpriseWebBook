...
TIP: The http://www.responsinator.com/[Responsinator Web site] offers an easy way to see how the jQuery Mobile version of the Save The Child application looks at various iOS and Android devices. Just enter    
http://savesickchild.org:8080/ssc-jquery-mobile/[the URL of this version] and try to use it on various emulators offered by Responsinator. 
