...
TIP: If you want to control how much overtical or horizontal screen space is given to each component, use the `flex` property as described in Chapter 4 in the section <<MMMMMMMMMMMMMM>>.
