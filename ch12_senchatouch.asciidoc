...
The Sencha Touch version of the Save The Child application is based on the mock-up presented in Chapter 11 ("Prototyping Mobile Version") with some minor changes. This time the home page of the application will be a slightly different version of the About page shown on <<FIG13-11>>. 
