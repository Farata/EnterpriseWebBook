...
Read more about the role of controllers in event handling in the section <<MMMMM>> later in this chapter. Online documentation includes the http://docs.sencha.com/touch/2.3.1/#!/guide/events[Event Guide] - it describes the process of handling events in detail.
