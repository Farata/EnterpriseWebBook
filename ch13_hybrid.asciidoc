...
NOTE: While using the command +phonegap create HelloWorld com.example.hello "Hello World"+, keep in mind that for iOS, you'll need to create a certificate, which has to be valid for application packages located under _com.example_. For more details, see the section <<MMMMMMMM>>.
