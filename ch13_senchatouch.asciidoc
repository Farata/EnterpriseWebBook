...
Now let's review the code of the Login page controller. We have not implemented any login logic - it simply reacts on the UI interaction. The name of this file is Login.js, it's located in the folder _controller_, and here's the code: 
...
<3> This controller uses components from the LoginForm view (it's code comes a bit later).
