...
You'll see a more advanced example of the inter-component communication techniques that uses  _Mediator Design Pattern_ in <<mediator_section,corresponding section>> of Chapter 7.
