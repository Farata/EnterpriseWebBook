...
WARNING: http://www.w3.org/TR/webdatabase/[Web SQL Database], is being used as the local database supporting SQL syntax. The work on this specification is stopped and future versions of the browser may not support it. 
