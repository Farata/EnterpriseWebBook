...
The source code of this example is shown next. It's just two HTML files: mainWindow.html and myFrame.html. Here;s the code of the mainWindow:
...
<body bgcolor="cyan">
   ...
   <script type="text/javascript">
        ...
        function handleMessage(event) {
                console.log('Main Window got the message ' +  event.data );
 ...
 <body bgcolor="white">
  ...
  <script type="text/javascript">
        ...
        window.onload = function(){
            ...
            parent.postMessage('loaded', 'http://127.0.0.1:8020');
        };
