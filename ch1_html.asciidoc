...
We will cover more advanced inter-component communication techniques based _Mediator Design Pattern_ in <<mediator_section,corresponding section>> of Chapter 7.
