...
But we web developers need to worry about other things, like making web pages responsive and lightweight. The first thing you need to do after receiving the prototype from Jerry is run it through Google Developer Tools or Firebug (see <<debugging_javascript>> for details) and measure the total size of the resources being downloaded from the server. If your application loads 1 MB or more worth of images, ask Jerry to review the images and minimize their size.(((web design, prototypes, determining resource size)))((("responsive web design (RWD)", "determining resource size")))(((Firebug, determining resource size)))
