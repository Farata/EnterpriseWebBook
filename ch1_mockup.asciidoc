...
Lorem Ipsum is a dummy text widely used in printing, typesetting, and web design. It's used as a placeholder to indicate the text areas that should be filled with real content later. You can read about it at http://www.lipsum.com/[http://www.lipsum.com]. <<>>shows what the HTML fragment supporting <<FIG3-10>> looks like (no CSS is shown for brevity).
