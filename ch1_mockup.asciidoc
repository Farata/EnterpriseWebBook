...
This project has several directories to keep JavaScript, images, CSS, and fonts separate. We'll talk about special icon fonts later in this section, but first things first: let's take a close look at the HTML code in <<>>. 
