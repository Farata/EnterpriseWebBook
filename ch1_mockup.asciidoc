...
[NOTE]
====
We assume that the readers know how to write programs in JavaScript. If you are not familiar with this language, study the materials from <<appendix_a, Appendix A>> first. You'll find a fast paced introduction to JavaScript there.
====
