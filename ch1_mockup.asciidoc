...
2. The main area with the Donate section plus the video player 
3. The area with statistics, and charts. 
4. The footer with several house-keeping links plus the icons for Twitter and FaceBook.
...
We are lucky - Jerry knows HTML and CSS. He's ready to turn the still mockups into the first working prototype. It'll use only hard-coded data but the layout of the site will be done in CSS and we’ll use HTML5 markup. He'll design this application as a Single-Page Application (SPA).
