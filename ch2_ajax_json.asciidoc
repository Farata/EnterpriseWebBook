...
This code uses the CSS selector `error` that will show the error message on the red background. You can find it in the file _styles.css_ in _project-02-donation-error-ajax-html_. It looks like this:
