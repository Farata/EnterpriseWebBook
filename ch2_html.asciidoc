...
If this example doesn't impress you, wait till Chapter 12, where you'll learn how to use jQuery Mobile. The creators of this library use these `data-` attributes in a very smart way.
*****
