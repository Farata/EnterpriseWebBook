...
TIP: To see code samples of using the Responsive Carousel plug-in (including popular autoplaying slide shows), check out the http://bit.ly/1prR6tB[Responsive Carousel variations].
