...
TIP: Youtube offers https://www.youtube.com/html5[ an Opt-In Trial of HTML5 video], which allows the users to request playing most of the videos using HTML 5 video (even those recorded for Flash Player).
