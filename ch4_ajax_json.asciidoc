...
In the real world Web application that run nationwide charity events and donation campaigns couuld be integrated with some content management systems that would maintain the information about current events and make it available as JSON data feed. 
