...
<2> The right side of the `hbox` is another container with the `vbox` internal layout to show the "We accept PayPal" message, Donate Now, and I'll donate later buttons (see <<FIG6-7-SSC>>). You can find event handlers for these buttons in the controller _Donate.js_.       
...
----
.Example 4-36 Processing Login clicks in the controller
...
----
.Example 4-37 The VideoPanel component
...
----
.Example 4-38 The CampaignsMap component. Part 1
...
----
.Example 4-39 The CampaignsMap component. Part 2
