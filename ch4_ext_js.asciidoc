...
----
.Example 4-22 Two ways of adding event listeners
...
----
.Example 4-23 Two ways of removing event listeners
...
----
.Example 4-24 Subscribing to events in config object
...
----
.Example 4-25 A container with the border layout
...
----
.Example 4-26 Setting proportional layout with `flex` property
