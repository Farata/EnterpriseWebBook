...
Right-click the project name SSC_Top_ExtJS, select the menu Run as | Run on server. Eclipse may offer to restart the server - accept it, and you'll see the top portion of the Save The Child application running in the internal browser of Eclipse that will look as shown on <<FIG6-2-SSC>>. 
...
----
.Example 4-27 The app.js from top portion of Save The Child
...
----
.Example 4-28 The Donate controller of Save The Child
