...
----
.Example 4-1 The first version of Hello World index.html
...
----
.Example 4-2 The app.js from Hello World example

This `Ext.application()` method gets a _configuration object_  as an argument - JavaScript literal - with configured `launch` method that's called automatically when the Web page has completely loaded. In our case this object literal mandates to launch the anonymous function that displays the "Hello World" message. In Ext JS you'll be using such configuration objects a lot.
...
----
.Example 4-3 Passing config object to Ext JS Panel
...
----
.Example 4-4 Setting a namespace for your application
*********
