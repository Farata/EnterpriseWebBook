...
TIP: To make WebStorm work faster, exclude the directories _ext_, _packages_, _build_, and _WEB-INF_ from the project (click the wrench icon on the toolbar and then select Directories -> Excluded). This way WebStorm won't be indexing these directories.
