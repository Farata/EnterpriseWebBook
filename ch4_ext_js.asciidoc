...
<1> The rest of the code in this class has the same mapping functionality as described in <<mocking_up_the_app>> in the section "<<MMMMMMMMMMMMMMMM>>."
...
----
.Example 4-40 The app.js of Save The Child
...
-----
.Example 4-41 The Campaigns store
