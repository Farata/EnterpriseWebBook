...
The search tool found a bunch of generators that have the keyword +requirejs+ in their name or description. We're looking for a generator that "requirejs" (see <<yo_serach>>, highlighted with a red square). When we click the name link, the https://github.com/danheberden/yeoman-generator-requirejs[GitHub page of RequireJS generator] displays. Usually, the generator developers provide a reference of the generator's available tasks.
