...
+requirejs+::
    Build a RequireJS project.
+connect+::
    Start a connect web server.
+default+::
    Alias for +jshint+, +qunit+, +clean+, +requirejs+, +concat+, +uglify+ tasks.
+preview+::
    Alias for +connect:development+ task
    +preview-live+::
        Alias for +default+, +connect:production+ tasks.
