...
TIP: The WebStorm IDE has http://bit.ly/1rpYtzz[built-in support] for the JSHint tool. There is a third-party plugiin for Eclipse: http://github.eclipsesource.com/jshint-eclipse/[jshint-eclipse].
...
The search tool found a bunch of generators that have the keyword +requirejs+ in their name or description. We're looking for a generator that "requirejs" (see <<yo_serach>>, highlighted with a red square). When we click the name link, the http://bit.ly/1q3Xkhf[GitHub page of the RequireJS generator] displays. Usually, the generator developers provide a reference of the generator's available tasks.
