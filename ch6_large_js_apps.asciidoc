...
<4> The +uglify+ task minifies files using http://lisperator.net/uglifyjs/[UglifyJS]—a compressor/minifier tool. Input and output of this task is configured with +src+ and +dest+ properties of +uglify+ object.
