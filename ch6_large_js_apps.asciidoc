...
Examples pass:[<xref linkend="ex_pricepanel_module" xrefstyle="select: labelnumber"/>] and pass:[<xref linkend="ex_orderpanel_module" xrefstyle="select: labelnumber"/>] shows the code of the `PricePanel` and `OrderPanel` components.  
