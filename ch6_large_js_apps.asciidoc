...
Furthermore, _r.js_ integrates with other optimization tools such as https://github.com/mishoo/UglifyJS2[UglifyJS] and http://bit.ly/1lJvK8M[Closure Compiler] to minify the content of script files. We are going to use the JavaScript task runner http://gruntjs.com/[Grunt] that you learned about in <<productivity_tools>>. 
