...
Using the +globals+ option in the _compile-modules_ command line produces the code that can be used as described in the Module Pattern section earlier in the chapter. 
