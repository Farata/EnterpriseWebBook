...
Using the +globals+ option in the +compile-modules+ command line produces the code that can be used as described in the section "MMMMMMMMMMMMMMMMMMMM" earlier in the chapter. 
