...
// vik
At this point, you should get the idea how to load module's code. Next, let's see what is inside a module's file that it can be consumed by a module loader.
