...
TIP: Google has created https://developers.google.com/speed/pagespeed/insights/[PageSpeed Insights], a Web tool that offers suggestions for improving the performance of your Web application on all device. Just enter the URL of your application and a second later you'll see some optimization suggestions.
