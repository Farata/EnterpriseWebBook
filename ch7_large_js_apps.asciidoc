...
// vik
Here is an example of module definition using UMD notation. In following example, module can be used with AMD loader as we as one of variations of Module Pattern.
