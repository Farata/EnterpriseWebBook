...
As the application gets larger the latency grows accordingly, which is illustrated in the following 
...
In modularized applications you can easier localize the error.
...
* It's easy to get a mismatch between dependency array and callback arguments.
+
