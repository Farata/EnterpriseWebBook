...
PhantomJS is headless WebKit-based browser. You can read how to leverage PhantomJS for test-driven development <<WHAT_IS_PHANTOMJS,later in this chapter>>. You can read more how you can use PhantomJS for performance testing our your application in presentation called http://wesleyhales.com/slides/html5devconf2013/["Browser Performance metering with PhantomJS"].
