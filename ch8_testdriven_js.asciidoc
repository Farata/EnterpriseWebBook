...
After setup the testing harness for SaveSickChild application we will explain the testing strategy for ExtJS application. We will start with testing the models and controllers, after that we will test our views. And 
