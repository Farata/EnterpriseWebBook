...
<1> The function `describe` accepts two parameters - the name of the test suite, and the callback function. The function is a block of code that implements the suite.

<2> The function `it` accepts two parameters - the name of the test specification, and the function that implements this specification.

<3> Each suite can have any number of specifications.
