...
<2> An array of file names to load in the browser.
<3> An array of file names to be excluded from loading.
<4> An array of browser names to be used to execute JavaScript code.
<5> If true, it captures browsers, runs the tests and exit.
