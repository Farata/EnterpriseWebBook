...
The https://www.owasp.org[ Open Web Application Security Project (OWASP)] is an open-source project focused on improving security of web applications by providing a collection of guides and tools. OWASP publishes and maintains a list of the https://www.owasp.org/index.php/Category:OWASP_Top_Ten_Project[top 10 security risks]. Figure <<FIG10-1>> shows how this list looked in 2013.
