...
Repudiation::
    The user denies sending data (for example, making an online transaction such as a purchase or sale) by modifying the application's log files.(((repudiation attacks))) 
