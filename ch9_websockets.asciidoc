...
The https://github.com/flowersinthesand/portal[Portal] is a server agnostic JavaScript library that not only provides a socket connection for the browser-based applications that need two-way communication with servers, but also aims to utilize a full duplex connection for modern web application development. It supports various transports (long polling, HTTP streaming, WebSocket).

==== Atmosphere ====

https://github.com/Atmosphere/atmosphere[Atmosphere] is a portable WebSocket/Comet framework supporting Java, Groovy, Scala. The Atmosphere Framework contains both client and server components for building Asynchronous Web Applications. The majority of popular frameworks are either supporting Atmosphere or supported natively by the framework. The Atmosphere Framework supports all majors Browsers and Servers. The clent side component - Atmosphere.js[https://github.com/Atmosphere/atmosphere/wiki/jQuery.atmosphere.js-API] - simplifies the development of Web applications that require a fall back from WebSocket protocol to long polling or HTTP streaming.
