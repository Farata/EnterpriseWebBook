...
The authors of this book also maintain  http://savesickchild.org:8080/ssc-responsive/[the Web site], where various versions of the sample Save The Child application are deployed so you can see them in action.
