...
[role="large-8 columns"]
This book will be printed in early Spring of 2014, but you can [line-through]*enjoy* read the current manuscript enterprisewebbook.com. The sources of this book are located at https://github.com/Farata/EnterpriseWebBook[Github].
...
<a class="small button" href="http://shop.oreilly.com/product/0636920028314.do?&code=DSUG">Buy Early Release with discount at O'Reilly</a>
